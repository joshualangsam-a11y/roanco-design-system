...
window.NavTicker = function NavTicker() {
  const items = [
    { k: 'ENTITY', v: 'DELAWARE C-CORP', c: '#09FBD3' },
    { k: 'FOUNDERS', v: 'DICHTER · LANGSAM', c: '#FF6FB5' },
...
window.TimelineRail = function TimelineRail() {
  ...
  const events = [
    { y: '2023', t: 'Roan Co.', d: 'Dichter & Langsam co-found the company. AI-augmented tools for slow industries.' },
    ...
    { y: '2026', t: 'Now', d: 'Building in Jupiter, FL. Delaware C-Corp. Open for select work.' },
  ];
  ...
  return (
    <section id="trajectory" style={{ padding:'96px 0 80px', position:'relative', background:'rgba(11,19,43,.55)', borderTop:'1px solid rgba(255,42,193,.18)', borderBottom:'1px solid rgba(255,42,193,.18)' }}>
